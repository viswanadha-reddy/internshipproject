...
function loadMusic(indexNumb) {
    ...
    musicImg.src = `romanticimage/${allMusic[indexNumb - 1].img}.jpeg`;
    mainAudio.src = `romanticsong/${allMusic[indexNumb - 1].src}.mp3`;
}
...
for (let i = 0; i < allMusic.length; i++) {
    ...
    <audio class="romaticsongs/${allMusic[i].src} " src="songs/${allMusic[i].src}.mp3"></audio>
    <span id="romaticimage${allMusic[i].src}" class="audio-duration">1:45</span>
  </li>`;
